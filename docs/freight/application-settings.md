...
The application settings can only be accessed and configured by an administrator of the application. The settings are available from the **Your Name -> :fontawesome-solid-gear: Settings** dropdown menu. The settings are separated by category to which they correspond.
